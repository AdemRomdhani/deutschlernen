...
out = "C:/Users/Adem/OneDrive/Bureau/workspace/src/proData.json"

data = {"GRAMMAR_INTERACTIVE": {"A1": [], "A2": [], "B1": [], "B2": [], "C1": []}}
...
for sent, parts, q, c in a1:
    data["GRAMMAR_INTERACTIVE"]["A1"].append({"level":"A1","sentence":sent,"parts":[{"word":w,"role":r,"correctCase":cc} for w,r,cc in parts],"question":q,"options":["Nominativ","Akkusativ","Dativ","Genitiv"],"correct":c})
...
for sent, parts, q, c in a2:
    data["GRAMMAR_INTERACTIVE"]["A2"].append({"level":"A2","sentence":sent,"parts":[{"word":w,"role":r,"correctCase":cc} for w,r,cc in parts],"question":q,"options":["Nominativ","Akkusativ","Dativ","Genitiv"],"correct":c})
...
for sent, parts, q, c in b1:
    data["GRAMMAR_INTERACTIVE"]["B1"].append({"level":"B1","sentence":sent,"parts":[{"word":w,"role":r,"correctCase":cc} for w,r,cc in parts],"question":q,"options":["Nominativ","Akkusativ","Dativ","Genitiv"],"correct":c})
...
for sent, parts, q, c in b2:
    data["GRAMMAR_INTERACTIVE"]["B2"].append({"level":"B2","sentence":sent,"parts":[{"word":w,"role":r,"correctCase":cc} for w,r,cc in parts],"question":q,"options":["Nominativ","Akkusativ","Dativ","Genitiv"],"correct":c})
...
for sent, parts, q, c in c1:
    data["GRAMMAR_INTERACTIVE"]["C1"].append({"level":"C1","sentence":sent,"parts":[{"word":w,"role":r,"correctCase":cc} for w,r,cc in parts],"question":q,"options":["Nominativ","Akkusativ","Dativ","Genitiv"],"correct":c})
